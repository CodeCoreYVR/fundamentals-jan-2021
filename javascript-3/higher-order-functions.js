...
function map(arr, cb) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    // The return value of that invocation is the new value mapped to the output array, so push it
