...
// join and split
// Array method -> join(string) joins together all elements in an array, spearated by the argument "string" and returns that string
// It does not mutate the array that it was called on
